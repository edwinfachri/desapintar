...
@endif -->
<div class="row">
  {{ Form::open(array('url'=>'ket_tidak_mampu', 'method'=>'POST')) }}
  {{ csrf_field() }}
  <div class="form-horizontal">
    <div class="form-group">
      ...
      <div class="col-md-9 col-xs-9 col-lg-9">
        {!! Form::text('nomor', '', ['id'=>'nomor', 'class'=>'form-control', 'placeholder'=>'Nomor Surat']) !!}
        @if ($errors->has('nomor'))
    ...
    <div class="form-group">
      ...
      <div class="col-md-9 col-xs-9 col-lg-9">
        {!! Form::text('nilk', '', ['id'=>'nilk', 'class'=>'form-control', 'placeholder'=>'NILK']) !!}
        @if ($errors->has('nilk'))
            <span class="help-block">
    ...
    <div class="form-group">
      ...
      <div class="col-md-9 col-xs-9 col-lg-9">
        {!! Form::select('kelamin', Helper::generateArray("ref","refno","reftext"," refid='1' order by refno"), '', ['id'=>'kelamin', 'class'=>'form-control']) !!}
    ...
    <div class="form-group">
      ...
      <div class="col-md-9 col-xs-9 col-lg-9">
        {!! Form::text('kewarganegaraan', '', ['id'=>'kewarganegaraan', 'class'=>'form-control', 'placeholder'=>'Kewarganegaraan']) !!}
    ...
    <div class="form-group">
      ...
      <div class="col-md-9 col-xs-9 col-lg-9">
        {!! Form::select('agama', Helper::generateArray("ref","refno","reftext"," refid='2' order by refno"), '', ['id'=>'agama', 'class'=>'form-control']) !!}
        @if ($errors->has('agama'))
            <span class="help-block">
    ...
    <div class="form-group">
      ...
      <div class="col-md-9 col-xs-9 col-lg-9">
        {!! Form::text('pekerjaan', '', ['id'=>'pekerjaan', 'class'=>'form-control', 'placeholder'=>'Pekerjaan']) !!}
    ...
    <div class="form-group">
      ...
      <div class="col-md-9 col-xs-9 col-lg-9">
        {!! Form::text('status', '', ['id'=>'status', 'class'=>'form-control', 'placeholder'=>'Status']) !!}
    ...
    <div class="form-group">
      ...
      <div class="col-md-9 col-xs-9 col-lg-9">
        {!! Form::text('masa_berlaku_start', '', ['id'=>'masa_berlaku_start', 'class'=>'form-control datepicker', 'placeholder'=>'Mulai Masa Berlaku']) !!}
    ...
    <div class="form-group">
      ...
      <div class="col-md-9 col-xs-9 col-lg-9">
        {!! Form::text('masa_berlaku_end', '', ['id'=>'masa_berlaku_end', 'class'=>'form-control datepicker', 'placeholder'=>'Berakhir Masa Berlaku']) !!}
