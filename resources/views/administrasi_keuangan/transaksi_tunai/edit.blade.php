...
?>
<div class="row">
  {{ Form::model($data, array('route' => array('transaksi_tunai.update', $data->id), 'method' => 'PUT', 'files'=>true)) }}
  {{ csrf_field() }}
  <div class="form-horizontal">
    ...
    <div class="form-group">
      ...
      <div class="col-md-9 col-xs-9 col-lg-9">
        {!! Form::select('kd_rek', Helper::generateArray("ref","refno","reftext"," refid='99999' order by refno"), $data->kd_rek, ['id'=>'kd_rek', 'class'=>'form-control']) !!}
    ...
    <div class="form-group">
      ...
      <div class="col-md-9 col-xs-9 col-lg-9">
        {!! Form::select('jenis_dana', Helper::generateArray("ref","refno","reftext"," refid='3' order by refno"), $data->jenis_dana, ['id'=>'jenis_dana', 'class'=>'form-control']) !!}
