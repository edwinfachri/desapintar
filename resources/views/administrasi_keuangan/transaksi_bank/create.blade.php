...
?>
<div class="row">
  {{ Form::open(array('url'=>'transaksi_bank', 'method'=>'POST', 'files'=>true)) }}
  {{ csrf_field() }}
  <div class="form-horizontal">
    ...
    <div class="form-group">
      ...
      <div class="col-md-9 col-xs-9 col-lg-9">
        {!! Form::select('jenis_transaksi', Helper::generateArray("ref","refno","reftext"," refid='4' order by refno"), '', ['id'=>'jenis_transaksi', 'class'=>'form-control']) !!}
