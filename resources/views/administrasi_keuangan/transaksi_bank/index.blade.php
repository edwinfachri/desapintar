...
<br>
<div class="row">
  <h1><a class="btn btn-primary form-control" href="{{ url('transaksi_bank/create') }}" role="button">Transaksi Baru</a></h1>
</div>
<hr>
<div class="row">
          ...
          <td>
            ...
            <div class="form-inline pull-right">
               <div class="form-group">
                 <a class="btn btn-default btn-info" href="{{ url('transaksi_bank/'.$datum->id.'/view') }}" role="button">Lihat Surat</a>
               </div>
               <div class="form-group">
                 <a class="btn btn-default btn-success" href="{{ url('transaksi_bank/'.$datum->id.'/edit') }}" role="button">Sunting Surat</a>
               </div>
               <div class="form-group">
                 {{ Form::open(array('url' => 'transaksi_bank/' . $datum->id, 'class'=>'delete')) }}
